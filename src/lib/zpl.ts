...
export const generateSalesZpl = (item: SalesItem, format: string = "60x80"): string => {
...
^LL640
^CI28
^FO20,30^A0N,25,25^FB440,1,0,L,0^FDDe R$ ${priceFromFormatted}^FS
^FO20,70^A0N,45,45^FB440,1,0,L,0^FDPor R$ ${priceToFormatted}^FS
^FO360,78^A0N,30,30^FB440,1,0,L,0^FD(A vista)^FS
^FO20,120^A0N,20,20^FB440,2,0,L,0^FDOu em ate ${item.installmentCount}x de ${installmentsFormatted} sem juros^FS
^XZ`;
  }
...
^FO20,420^A0N,20,20^FB440,2,0,L,0^FDOu em ate ${item.installmentCount}x de ${installmentsFormatted} sem juros^FS
